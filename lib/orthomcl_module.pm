...
use lib "/ifs4/BC_PUB/biosoft/pipeline/DNA/DNA_evolution/Plant/01.gene_family/lib";
use Bio::SearchIO;
use Storable;
require Exporter;
...
# softwares
our $BLASTALL                            = "/opt/blc/genome/bin/blastall";
...
our $FORMATDB                            = "/opt/blc/genome/bin/formatdb";
our $MCL                                 = "/ifs4/BC_PUB/biosoft/pipeline/DNA/DNA_evolution/Plant/01.gene_family/bin/software/mcl";

# path
our $PATH_TO_ORTHOMCL                    = "./output/";   # must end with "/"
